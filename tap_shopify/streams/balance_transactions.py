...
class BalanceTransactions(Stream):
    """
    Balance transaction stream that syncs by payout ID instead of date windows.
    This ensures all BTs for a payout are captured even when the payout takes
    days to reach PAID status.
    """
