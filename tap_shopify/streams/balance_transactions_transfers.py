...
class BalanceTransactionsTransfers(Stream):
    ...
    def get_query_params(self, updated_at_min, updated_at_max, cursor=None):
        ...
        params = {
            "query": f"processed_at:>='{updated_at_min}' AND processed_at:<'{updated_at_max}' AND payout_status:'PAID' AND transaction_type:'TRANSFER'",
